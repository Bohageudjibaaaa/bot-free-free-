...
TOKEN = '7282221906:AAGOLIh53tRRgFuCTnyZom2uZbeocNl2wvM'
admin_ids = ['6358623706']
...
def main(msg: Message):
    ...
    if msg.text.startswith("/start"):
        ...
        url_button = InlineKeyboardButton(text="᧒᥆Ꭵꪀ ꪀ᥆᭙ 👀", url="https://www.instagram.com/boha_geudjiba?igsh=ZWVvZmp1YWdxdHF3")
        keyboard.add(url_button)
        bot.reply_to(msg, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 👋 \n𝗙𝗢𝗥 𝗚𝗘𝗧 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 𝗔𝗕𝗢𝗨𝗧 𝗜𝗗 ℹ 𝗨𝗦𝗘 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 id", reply_markup=keyboard)
    ...
    if msg.text.startswith("id"):
        ...
        keyboard = InlineKeyboardMarkup()
        url_button = InlineKeyboardButton(text="⧉ ƒ᥆ᖇ ꪔ᥆ᖇᥱ Ꭵꪀƒ᥆ 👀", url="https://www.instagram.com/boha_geudjiba?igsh=ZWVvZmp1YWdxdHF3")
        keyboard.add(url_button)
